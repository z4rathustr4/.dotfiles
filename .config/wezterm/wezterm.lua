...
local font_name = "Hack NF FC Ligatured"
...
return {
	...
	keys = {
    { key = 'PageUp', mods = 'NONE', action = wezterm.action.SendKey { key = 'phys:Home' } },
    { key = 'PageUp', mods = 'ALT', action = wezterm.action.SendKey { key = 'phys:PageUp' } },
    { key = 'PageDown', mods = 'ALT', action = wezterm.action.SendKey { key = 'phys:PageDown' } },
    { key = 'PageDown', mods = 'NONE', action = wezterm.action.SendKey { key = 'phys:End' } },
