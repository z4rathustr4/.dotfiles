...
-- [[
-- Setup flutter-tools.nvim (custom, @z4rathustr4)
-- ]]
...
local on_attach = function(_, bufnr)
  ...
  -- [[ CUSTOM_LSP_FUNC ]]
  -- lsp.lua https://github.com/z4rathustr4/.dotfiles/blob/main/nvim/after/plugin/lsp.lua
  nmap("<leader>vd", function() vim.diagnostic.open_float() end)
  nmap("<leader>va", function() vim.lsp.buf.code_action() end)
